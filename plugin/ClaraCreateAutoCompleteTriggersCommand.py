...
FILE_CONTENTS = '''
// This file was auto-generated by the Clara plugin. You can freely modify it.
{
	"auto_complete_selector": "- comment - string - constant",
	"auto_complete_triggers": 
	[
		{
			"selector": "- comment - string - constant", 
			"characters": "."
		},
		{
			"selector": "- comment - string - constant", 
...
class ClaraCreateAutoCompleteTriggersCommand(sublime_plugin.ApplicationCommand):
